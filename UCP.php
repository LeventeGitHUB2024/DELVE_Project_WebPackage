...
/*$pdo = db(); 
$stmt = $pdo->prepare("
SELECT players_pyr.*, saves_sae.*
FROM players_pyr
LEFT JOIN saves_sae ON players_pyr.PYR_id = saves_sae.PYR_id
WHERE players_pyr.PYR_id = :pyr_id
");
$stmt->execute(['pyr_id' => $_SESSION['user_email']]);  // Ha a PYR_id az email, akkor használhatod az email-t
$user = $stmt->fetch(PDO::FETCH_ASSOC);

// Kiírhatod a felhasználó adatait és a kapcsolódó táblák mezőit
echo htmlspecialchars($user['name']);
echo htmlspecialchars($user['email']);
echo htmlspecialchars($user['Full_start_date']);  // A saves_sae tábla Full_start_date mezője
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <th class="fw-bold">Total Playtime:</th>
                                    <td></td>
